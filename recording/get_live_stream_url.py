...
# def repeat_get_live_stream_url(url):
#     headers = {
...
# def repeat_get_live_stream_url(url, max_attempts=5):
#     """
#     獲取直播流 URL 並返回狀態。
#     """
#     headers = {
...
def main():
    ...
    live_stream_url = repeat_get_live_stream_url(url)
    if live_stream_url:
